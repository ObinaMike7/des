-- Inventory System seed for local Supabase CLI usage.
-- Note: user accounts are seeded via `node setup-db.js` (passwords are hashed in JS).
...
-- Products schema + sample categories/products
DO $$
BEGIN
